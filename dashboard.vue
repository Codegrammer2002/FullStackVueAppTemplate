...
//custom methods
	...
	//delete account
		async deleteAccount(){	
			...
			//notify
				try{
				 await axios.post('/api/posts/deleteUser', {username: localStorage.getItem("loginUser")});

				toastr.success(`Account Deleted  successfully!`, ``, {'closeButton': true, positionClass: 'toast-bottom-right'});
				}
				catch(err){
					console.log(err);
